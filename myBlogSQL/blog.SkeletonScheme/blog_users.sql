...
CREATE TABLE `users` (
  ...
  `email` varchar(100) NOT NULL COMMENT 'User email address, VARCHAR.',
  `created_at` datetime NOT NULL COMMENT 'Timestamp of when the user was created, DATETIME.',
  PRIMARY KEY (`id`),
...
-- Dump completed on 2024-04-30 16:25:31
