...
CREATE TABLE `post` (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT 'id: Primary key, integer, auto-increment.',
...
-- Dump completed on 2024-05-06 13:29:06
